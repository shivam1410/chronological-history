...
|---|---|---|---|
| `aadhaar` | UIDAI | GODL-India | [Commons](https://commons.wikimedia.org/wiki/File:Aadhaar.svg) |
| `abolition-brazil` | Valter Campanato/Agência Brasil | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Mostra_Brasilis_a_Bras%C3%ADlia_03.jpg) |
| `abolition-british` | Sodacan | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Coat_of_arms_of_Great_Britain_(1714%E2%80%931801).svg) |
| `abolition-us` | Ssolbergj | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Greater_coat_of_arms_of_the_United_States.svg) |
...
| `al-biruni` | Michel Bakni | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Al-Biruni_Portrait.jpg) |
...
| `analects` | Confucius and his disciples, | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Rongo_Analects_02.jpg) |
| `andronovo-culture` | Krakkos | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Andronovo_culture.jpg) |
| `angkor-wat` | Bjørn Christian Tørrissen | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Angkor_Wat.jpg) |
| `antonine-plague` | Tataryn77 | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Aurelius180AD.png) |
| `apartheid` | Guinnog | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:DurbanSign1989.jpg) |
| `apes-emerge` | de:Matthias Trautsch | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Weisshandgibbon_tierpark_berlin.jpg) |
| `aquinas` | Carlo Crivelli | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:St-thomas-aquinasFXD.jpg) |
| `arab-spring` | cjb | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Tunisian_Revolution_Protest.jpg) |
| `aral-sea` | NASA, derivative work by Zafiroblue05 at en.wikipedia | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Aral_Sea_1989-2008.jpg) |
| `archimedes` | Domenico Fetti | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Retrato_de_un_erudito_(%C2%BFArqu%C3%ADmedes%3F),_por_Domenico_Fetti.jpg) |
...
| `austen` | Cassandra Austen | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:CassandraAusten-JaneAusten(c.1810)_hires.jpg) |
| `australian-frontier-wars` | W.Walton after Louisa and Godfrey Charles Mundy | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Mounted_police_and_blacks.jpg) |
| `australopithecus` | Andrew from Cleveland, Ohio, USA | CC BY-SA 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Lucy_Skeleton.jpg) |
| `austronesian-expansion` | Stanislav Kozlovskiy | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Taiwanese_aborigines.JPG) |
| `avesta-written` | Daderot | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Videvdad_Sadah_(Zoroastrian_religious_code),_opened_to_first_chapter,_unknown_copyist,_Yazd,_Iran,_1647_AD_-_British_Library,_London_-_DSC00550.jpg) |
| `avicenna` | Adam Jones from Kelowna, BC, Canada | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Avicenna_Portrait_on_Silver_Vase_-_Museum_at_BuAli_Sina_(Avicenna)_Mausoleum_-_Hamadan_-_Western_Iran_(7423560860).jpg) |
| `ayutthaya` | Xiengyod | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Flag_of_Thailand_(Ayutthaya_period).svg) |
| `aztec-empire` | File:Aztec Empire (orthographic projection).svg: Keepscases Derivative work: Giggette | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Aztec_Empire_ME_(orthographic_projection).svg) |
| `babbage` | Thomas Dewell Scott | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:CharlesBabbage.jpg) |
| `bach` | Elias Gottlob Haussmann | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Johann_Sebastian_Bach.png) |
| `bangladesh-independence` | ExcelD24 | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:BangladeshLiberationWarMontage.jpg) |
| `baroque` | General Cucombre from New York, USA | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Doria_Pamphili_6284.jpg) |
| `basho` | unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Basho_by_Buson.jpg) |
| `beatles` | Bo Trenter | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Beatles_Trenter_1963.jpg) |
...
| `benin-bronzes` | en:Warofdreams | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Benin_Bronzes.jpg) |
...
| `borges` | Grete Stern | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Jorge_Luis_Borges_1951,_by_Grete_Stern_(full).jpg) |
...
| `brexit` | Furfur | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Location_map_of_the_United_Kingdom_and_the_European_Union.svg) |
...
| `cao-xueqin` | Yongxinge | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Statue_of_Cao_Xueqin.JPG) |
| `caravaggio` | Ottavio Leoni | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Bild-Ottavio_Leoni,_Caravaggio.jpg) |
| `carboniferous-forests` | Unknown author | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Plants_of_the_Carboniferous_age_MKL_Bd._15_1890_(128660878).jpg) |
...
| `chinua-achebe` | Carlo Bavagnoli | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Chinua_Achebe,_1966.jpg) |
...
| `chopin` | Louis-Auguste Bisson | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Frederic_Chopin_photo.jpeg) |
...
| `cold-war` | U.S. Army photo Photo Credit: USAMHI | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:US_Army_tanks_face_off_against_Soviet_tanks,_Berlin_1961.jpg) |
| `columbian-exchange-epidemics` | Tabac_rustique.jpg: Atilin Cacao-pod-k4636-14.jpg: The original uploader was Kbh3rd at English Wikipedia. VegCorn.jpg:? Potato_and_cross_section.jpg:? Latex_dripping.JPG: AxelBoldt Bright_red_tomato_and_cross_section02.jpg:? Vanilla_6beans.JPG:? derivative work: A111111 (talk) | GFDL | [Commons](https://commons.wikimedia.org/wiki/File:New_World_Domesticated_plants.JPG) |
| `columbus-1492` | Rezza Editores | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Viajes_de_colon_en2.svg) |
...
| `crispr` | Deposition authors: Nishimasu, H., Ishitani, R., Nureki, O.; Visualization author: Synpath | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Streptococcus_pyogenes_Cas9-DNA-RNA_complex_PDB_4OO8.png) |
...
| `deep-learning` | Sven Behnke | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Deep_Learning.jpg) |
...
| `descartes` | After Frans Hals | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Frans_Hals_-_Portret_van_Ren%C3%A9_Descartes.jpg) |
| `dickens` | Jeremiah Gurney | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Dickens_Gurney_head.jpg) |
| `dijkstra` | Andreas F. Borchert | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Edsger_Dijkstra_1994.jpg) |
| `dinosaur-era` | J. Spencer, Tadek Kurpaski, Daderot, Gary Todd, Domser, Captmondo. Collage by Matthew Martyniuk | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Various_dinosaurs2.png) |
| `dirac` | Nobel Foundation | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Paul_Dirac,_1933.jpg) |
| `dna-structure` | Zephyris | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:DNA_Structure%2BKey%2BLabelled.pn_NoBB.png) |
...
| `fela-kuti` | Distributed by Celluloid Records | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Fela_Kuti_circa_1986.jpg) |
...
| `feynman` | Copyright Tamiko Thiel 1984 | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:RichardFeynman-PaineMansionWoods1984_copyrightTamikoThiel_bw.jpg) |
| `financial-crisis-2008` | David Shankbone | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Lehman_Brothers_Times_Square_by_David_Shankbone.jpg) |
| `first-birds` | User Ballista on en.wikipedia | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Archaeopteryx_lithographica.JPG) |
| `first-mammals` | SPBer | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Sau_mit_ihren_Ferkeln.jpg) |
| `first-oceans` | Tim Bertelink | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Hadean.png) |
| `first-world-war` | Hohum | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:WWImontage.jpg) |
| `fleming-penicillin` | Official photographer | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Synthetic_Production_of_Penicillin_TR1468.jpg) |
| `flowering-plants` | Photo by and (c)2008 Derek Ramsey (Ram-Man). Co-attribution must be given to the Chanticleer Garden. | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Sweetbay_Magnolia_Magnolia_virginiana_Flower_Closeup_2242px.jpg) |
...
| `garcia-marquez` | Jose Lara | CC BY-SA 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Gabriel_Garcia_Marquez.jpg) |
...
| `goya` | Vicente López Portaña | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Vicente_L%C3%B3pez_Porta%C3%B1a_-_el_pintor_Francisco_de_Goya.jpg) |
...
| `great-zimbabwe` | Image taken by Jan Derk in 1997 in Zimbabwe. | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Great-Zimbabwe-2.jpg) |
...
| `hildegard-of-bingen` | Unknown author | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Hildegard_von_Bingen.jpg) |
...
| `hiv-aids` | Los Alamos National Laboratory | Attribution | [Commons](https://commons.wikimedia.org/wiki/File:Human_Immunodeficency_Virus_-_stylized_rendering.jpg) |
| `hokusai` | missing name | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Hokusai_as_an_old_man.jpg) |
| `holocaust` | Bernhard Walter | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Selection_on_the_ramp_at_Auschwitz-Birkenau,_1944_(Auschwitz_Album)_1b.jpg) |
| `holocene` | Ktrinko | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Mollweide.jpg) |
| `homer` | Photograph by Mike Peel (www.mikepeel.net). | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Homer_At_the_British_Museum_2024_(3x4_cropped).jpg) |
| `homeric-epics-written` | Rembrandt | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Rembrandt_Harmensz._van_Rijn_061.jpg) |
| `homo-erectus` | Gerbil | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Homme_de_Tautavel_01-08.jpg) |
| `homo-floresiensis` | Rama | CC BY-SA 3.0 fr | [Commons](https://commons.wikimedia.org/wiki/File:Homo_Florensiensis-MGL_95216-P5030051-white.jpg) |
| `homo-habilis` | John Hawks, Marina Elliott, Peter Schmid, Steven E. Churchill, Darryl J. de Ruiter, Eric M. Roberts, Hannah Hilbert-Wolf, Heather M. Garvin, Scott A. Williams, Lucas K. Delezene, Elen M. Feuerriegel, Patrick Randolph-Quinney, Tracy L. Kivell, Myra F. Laird, Gaokgatlhe Tawane, Jeremy M. DeSilva, Shara E. Bailey, Juliet K. Brophy, Marc R. Meyer, Matthew M. Skinner, Matthew W. Tocheri, Caroline VanSickle, Christopher S. Walker, Timothy L. Campbell, Brian Kuhn, Ashley Kruger, Steven Tucker, Alia Gurtov, Nompumelelo Hlophe, Rick Hunter, Hannah Morris, Becca Peixotto, Maropeng Ramalepa, Dirk van Rooyen, Mathabela Tsikoane, Pedro Boshoff, Paul H.G.M. Dirks, Lee R. Berger | CC BY 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:KNM_ER_1813_(H._habilis).png) |
| `homo-heidelbergensis` | Gerbil | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Mandibel_from_Mauer.JPG) |
...
| `ibn-khaldun` | Reda Kerbush | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Bust_of_Ibn_Khaldun_(Casbah_of_Bejaia,_Algeria).jpg) |
| `ibn-rushd` | Saleemzohaib | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Statue_of_Averroes_in_C%C3%B3rdoba,_Spain.jpg) |
...
| `india-liberalisation` | Prime Minister's Office | GODL-India | [Commons](https://commons.wikimedia.org/wiki/File:Official_Portrait_of_the_Prime_Minister_Dr._Manmohan_Singh_(3x4_cropped).jpg) |
...
| `iraq-war` | Technical Sergeant John L. Houghton, Jr., United States Air Force | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:UStanks_baghdad_2003.JPEG) |
...
| `james-webb` | NASA | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:JWST_spacecraft_model_3.png) |
...
| `kafka` | Unknown photographer | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Franz_Kafka,_1923.jpg) |
| `kalidasa` | NehalDaveND | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Kalidas.jpg) |
...
| `laetoli-footprints` | Momotarou2012 | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Laetoli_footprints_replica.jpg) |
| `land-plants` | Unknown | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Plants.jpg) |
| `laozi` | White whirlwind | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Laozi_(Chinese_characters).svg) |
| `lapita-culture` | Torbenbrinker | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:PortVilaLapita.jpg) |
| `last-glacial-maximum` | Unknown | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:CLIMAP.jpg) |
| `last-glacial-period` | Alps_location_map.png: Lencer derivative work: Jo (talk) | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Map_of_Alpine_Glaciations.png) |
| `latin-american-independence` | Ricardo Acevedo Bernal | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Congreso_de_C%C3%BAcuta.jpg) |
...
| `lovelace` | Margaret Sarah Carpenter | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Ada_Lovelace.jpg) |
| `lucy` | 120 | CC BY 2.5 | [Commons](https://commons.wikimedia.org/wiki/File:Reconstruction_of_the_fossil_skeleton_of_%22Lucy%22_the_Australopithecus_afarensis.jpg) |
| `lusophone-independence` | Unknown | Copyrighted free use | [Commons](https://commons.wikimedia.org/wiki/File:MatasdorioOnzo.jpg) |
| `m-pesa` | Vodafone | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:M-PESA.png) |
| `mabo-decision` | Sodacan | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Coat_of_arms_of_the_Commonwealth_of_Australia.svg) |
| `machu-picchu` | Pedro Szekely at https://www.flickr.com/photos/pedrosz/ | CC BY-SA 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Machu_Picchu,_Peru.jpg) |
| `madhvacharya` | AR767 | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Shri_Madhvacharya_Vigraha,_Pajaka,_Udupi.jpg) |
| `magnetic-compass` | Evan-Amos | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Plastic-compass.jpg) |
| `mahabharata` | Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Kurukshetra.jpg) |
| `mahavira` | Dayodaya | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Mahavir.jpg) |
| `maize-domestication` | Spedona | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Corntassel_7095.jpg) |
| `majapahit` | source: BP47Dhorifah, svg: Puck04 | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Naval_flag_of_Majapahit_Kingdom.svg) |
| `maji-maji-rebellion` | Maximilian Dörrbecker (Chumwa) | CC BY-SA 2.5 | [Commons](https://commons.wikimedia.org/wiki/File:Maji_Maji_rebellion_-_de.png) |
| `malaria` | Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Histopathology_of_malaria_exoerythrocytic_forms_in_liver_07G0024_lores.jpg) |
...
| `modernism` | H.Snyers | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:HSnyers_Louvrex_1933.jpg) |
| `monet` | Nadar | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Claude_Monet_1899_Nadar_crop.jpg) |
| `mongol-empire` | DannamEmpire | CC BY 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Expansion_of_the_Mongol_Empire_1206%E2%80%931294.gif) |
| `monte-alban` | Unknown | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Monte_Alb%C3%A1n_archeological_site,_Oaxaca.jpg) |
| `moon-landing` | Neil Armstrong | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Aldrin_Apollo_11_original.jpg) |
| `movable-type` | Willi Heidelbach | CC BY 2.5 | [Commons](https://commons.wikimedia.org/wiki/File:Metal_movable_type.jpg) |
| `mozart` | Barbara Krafft | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Wolfgang-amadeus-mozart_1.jpg) |
| `mrna-vaccines` | Arne Müseler | CC BY-SA 3.0 de | [Commons](https://commons.wikimedia.org/wiki/File:Covid19_vaccine_biontech_pfizer_3.jpg) |
| `mughal-empire` | nafSadh | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:MughalEmpire1700.svg) |
| `mughal-painting` | Govardhan (attribution) | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Govardhan._Jahangir_Visiting_the_Ascetic_Jadrup._ca._1616-20,_Musee_Guimet,_Paris.jpg) |
| `muhammad` | derivative work: Snitty (talk) Maome.jpg: Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Muslim_depiction_of_Muhammad_-_17th_century_Ottoman_copy_from_the_%22Edinburgh_codex%22.jpg) |
| `multicellular-life` | Unknown | CC BY 2.5 | [Commons](https://commons.wikimedia.org/wiki/File:C_elegans_stained.jpg) |
| `murasaki-shikibu` | Tosa Mitsuoki (1617 - 1691) | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Murasaki-Shikibu-composing-Genji-Monogatari.png) |
...
| `neanderthals` | Luna04 | CC BY 2.5 | [Commons](https://commons.wikimedia.org/wiki/File:Homo_sapiens_neanderthalensis.jpg) |
| `neolithic-revolution` | Unknown | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Knapp_of_Howar_2.jpg) |
| `new-zealand-wars` | DO'Neil at English Wikipedia | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Newzealandwarsmemorial.jpg) |
| `newton` | Godfrey Kneller | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Portrait_of_Sir_Isaac_Newton,_1689.jpg) |
| `nietzsche` | Friedrich Hermann Hartmann | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Nietzsche187a.jpg) |
| `nizami-ganjavi` | Attributed to Behzad, 1482 | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Nezami_(detail)_Addressing_his_Son_Mohammad._Attributed_to_Behzad,_Leyli_and_Majnun_(Nizami_Ganjavi)_1482.jpg) |
| `norse-vinland` | User carlb on en: | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Carlb-ansemeadows-vinland-01.jpg) |
...
| `omar-khayyam` | Alireza Javaheri | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Hakim_Omar_Khayam_-_panoramio.jpg) |
...
| `ottoman-empire` | User6054 | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Rise_of_Ottoman_empire.png) |
| `out-of-africa` | Unknown | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:World_map_of_prehistoric_human_migrations.jpg) |
| `ovid` | Lucasaw | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Ovid_by_an_anonymous_sculptor.jpg) |
| `oyo-empire` | The African History | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Palace_of_Alaafin_of_Oyo_circa_mid-1900s.jpg) |
| `pacific-nuclear-testing` | Jack W. Aeby, July 16, 1945, Civilian worker at Los Alamos laboratory, working under the aegis of the Manhattan Project. | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Trinity_shot_color.jpg) |
...
| `panama-canal` | Stan Shebs | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Panama_Canal_Gatun_Locks.jpg) |
...
| `peopling-of-americas` | Dbachmann | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Early_migrations_mercator.svg) |
...
| `plato` | Marie-Lan Nguyen | CC BY 2.5 | [Commons](https://commons.wikimedia.org/wiki/File:Plato_Silanion_Musei_Capitolini_MC1377.jpg) |
| `plato-on-socrates` | Photograph by Greg O'Beirne. Cropped by Tomisti | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:UWASocrates_gobeirne_cropped.jpg) |
| `pleistocene` | Scotese, Christopher R.; Wright, Nicky M. | CC BY 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Mollweide_Paleographic_Map_of_Earth,_21_Ka_(Late_Pleistocene_Age).png) |
| `png-independence` | Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Papua_New_Guinea_map.png) |
| `polio-vaccine` | USAID | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Poliodrops.jpg) |
| `polynesian-navigation` | HongKongHuey | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Hokule%27aSailing2009.jpg) |
| `pompeii` | Carsten Steger | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Aerial_image_of_Pompeii_and_Mount_Vesuvius_(view_from_the_southeast).jpg) |
| `potato-domestication` | Unknown | CC BY-SA 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Potato_sprout,_January_23,_2006.jpg) |
| `potosi-silver` | Parallelepiped09 | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Vista_de_la_Villa_Imperial_de_Potos%C3%AD.jpg) |
...
| `primates` | Lemur_catta_001.jpg: Alex Dunkel (Visionholder) Aye-aye_(Daubentonia_madagascariensis)_2b.jpg: * Aye-aye_(Daubentonia_madagascariensis)_2.jpg: Tom Junek derivative work: WolfmanSF (talk) Loris_tardigradus_tardigradus_003.jpg: Dr. K.A.I. Nekaris Bohol_Tarsier.jpg: mtoz Cebus_capucinus_(Cahuita).jpg: Hans Hillewaert Ateles_paniscus_-Brazil-8.jpg: Ana_Cotta Eating_Male_Papio_hamadryas.JPG: LadyofHats Hylobates_lar_pair_of_white_and_black_01.jpg: MatthiasKabel Pan_troglodytes_(male).jpg: Hans Hillewaert Tamarin_lion_à_tête_dorée.jpg: Thomas Bresson Camera location 47° 44′ 01.25″ N, 7° 21′ 00.63″ E View this and other nearby images on: OpenStreetMap 47.733681; 7.350175 There is a discrepancy of 9222172 meters between the above coordinates and the ones stored at SDC (9°44′10″N 82°50′20″W, precision: 5 m). Please reconcile them. derivative work: Miguelrangeljr | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Primates_-_some_families.jpg) |
...
| `quran-codified` | Gerd R. Puin | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:SanaaQuoranDoubleVersions.jpg) |
| `railways` | Arkady Rose | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Puffingbilly-side.jpg) |
| `ramanuja` | Kasyap | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Statue_Of_Equality_Samatha_Murthy.jpg) |
| `ramanujan` | Konrad Jacobs | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Srinivasa_Ramanujan_-_OPC_-_2_(cleaned).jpg) |
| `ramayana` | Sahibdin | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Battle_at_Lanka,_Ramayana,_Udaipur,_1649-53.jpg) |
| `ramcharitmanas` | Jānak De (scribe) | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:R%C4%81macaritam%C4%81nasa_manuscript_(19th_century).png) |
| `rapa-nui-decline` | kallerna | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Easter_Island_5.jpg) |
| `raphael` | Raphael | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Raffaello_Sanzio.jpg) |
| `ravi-shankar` | Markgoff2972 | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Ravi_Shankar.jpg) |
| `reform-and-opening` | 张元柏 | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:2011_%E6%B7%B1%E5%9C%B3_%E8%8E%B2%E8%8A%B1%E5%B1%B1%E9%A1%B6%EF%BC%8D%E9%82%93%E5%B0%8F%E5%B9%B3%E5%A4%B4%E5%83%8F_-_panoramio.jpg) |
| `reformation` | 95Thesen.jpg: Shizhao derivative work: 6birc (talk) | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:95Thesen_facsimile_colour.png) |
...
| `saadi-shirazi` | Hossein Behzad | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Saadi_by_Hossein_Behzad_(1894%E2%80%931968)_(Inverted).jpg) |
...
| `sartre` | T1980 | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Jean_Paul_Sartre_1967.jpg) |
...
| `second-world-war` | Staberinde | CC BY-SA 3.0 de | [Commons](https://commons.wikimedia.org/wiki/File:Infobox_collage_for_WWII.PNG) |
...
| `september-11` | Flickr user Michael Foran | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:WTC_smoking_on_9-11.jpeg) |
...
| `shakespeare` | Attributed to John Taylor | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Shakespeare.jpg) |
...
| `silk-road` | Kelvin Case Turkish Flame SmallJarsWithGreenLabels | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Silk_road_Kazakhstan.svg) |
...
| `smartphone` | Sage Ross | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Wikipedia_homepage_on_a_large_Android_phone,_2015-04-16.jpg) |
| `snowball-earth` | Oleg Kuznetsov - 3depix - http://3depix.com/ | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Snowball_Huronian.jpg) |
| `social-media` | Gemdation | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Social_media_platter.svg) |
| `socrates` | Copy of Lysippos (?) | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Socrates_Louvre.jpg) |
| `sogdian-merchants` | A.Davey from Portland, Oregon, EE UU | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Sogdian_Tribute_Bearers_on_the_Apadana_Staircase_16_(Best_Viewed_Size_%22Large%22)_(4689076272).jpg) |
...
| `soweto-uprising` | Sam Nzima | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Mbuyisa_Makhubu_carries_Hector_Pieterson_at_Soweto_Uprising.jpg) |
| `spinoza` | anonymous | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Spinoza.jpg) |
| `srivijaya` | Gunawan Kartapranata | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Srivijaya_Empire.svg) |
| `steam-engine` | Витольд Муратов | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:%D0%93%D0%BE%D1%80%D0%B8%D0%B7%D0%BE%D0%BD%D1%82%D0%B0%D0%BB%D1%8C%D0%BD%D0%B0%D1%8F_%D1%81%D1%82%D0%B0%D1%86%D0%B8%D0%BE%D0%BD%D0%B0%D1%80%D0%BD%D0%B0%D1%8F_%D0%BF%D0%B0%D1%80%D0%BE%D0%B2%D0%B0%D1%8F_%D0%BC%D0%B0%D1%88%D0%B8%D0%BD%D0%B0.JPG) |
| `stolen-generations` | The original uploader was Bjenks at English Wikipedia. | Attribution | [Commons](https://commons.wikimedia.org/wiki/File:QVB135lg.jpg) |
| `stone-tools` | Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:National_park_stone_tools.jpg) |
| `sui-dynasty` | Ian Kiu | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Cheui_Dynasty_581_CE.png) |
| `sun-yat-sen` | 上海波尔照相馆 | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:%E5%AD%99%E4%B8%AD%E5%B1%B1%E8%82%96%E5%83%8F.jpg) |
| `surdas` | India Post, Government of India | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Surdas.jpg) |
| `sushruta` | Unknown | CC BY 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Susruta._Pen_drawing._Wellcome_V0006619.jpg) |
| `swahili-coast` | FredD | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Shimoni_fishermen.JPG) |
| `tagore` | Generalstabens litografiska anstalt | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Rabindranath_Tagore_in_1909.jpg) |
| `taiping-rebellion` | Wu Youru | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Regaining_the_Provincial_City_Anqing2.jpg) |
| `taj-mahal` | Yann; edited by Jim Carter | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Taj_Mahal_(Edited).jpeg) |
| `talmud` | Reuvenk | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Talmud_set.JPG) |
| `tang-dynasty` | Ian Kiu | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Tang_Dynasty_circa_700_CE.png) |
| `tansen` | Anonymous Unknown author | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Tansen_of_Gwalior._(11.8x6.7cm)_Mughal._1585-90._National_Museum,_New_Delhi..jpg) |
| `taung-child` | Didier Descouens | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Australopithecus_africanus_-_Cast_of_taung_child.jpg) |
| `telegraph` | (c) 2006 Zubro | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Morse_Telegraph_1837.jpg) |
| `telescope` | Adriaen van de Venne | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Emblemata_1624.jpg) |
| `tenochtitlan` | thomas kole | CC BY 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Vista_completa_de_Tenochtitl%C3%A1n.jpg) |
| `teotihuacan` | Hdlrosa | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:ZA77_Teotihuac%C3%A1n_edo_de_mex_Herberto_de_la_rosa.jpg) |
| `tesla` | Napoleon Sarony | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Tesla_circa_1890.jpeg) |
| `tetrapods-on-land` | Steffen Häuser | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Feuer_Salamander_2.jpg) |
| `thales` | Sailko | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Arte_romana,_testa_di_talete_di_mileto,_II_sec..JPG) |
| `third-plague-pandemic` | Unknown | CC BY 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Man_being_injected_by_doctor,_during_the_outbreak_of_bubonic_Wellcome_V0029287.jpg) |
| `thiruvalluvar` | India Post, Government of India | GODL-India | [Commons](https://commons.wikimedia.org/wiki/File:Thiruvalluvar_1960_stamp_of_India.jpg) |
| `three-kingdoms` | Ian Kiu | CC BY 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Saam_Gwok_262_CE.png) |
...
| `tirukkural` | Naynapragasanar | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Thirukkural_Madras_1812.JPG) |
...
| `ukraine-invasion` | Viewsridge | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:2022_Russian_invasion_of_Ukraine.svg) |
...
| `umm-kulthum` | Production company | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Umm_Kulthum_as_Fatimah.jpg) |
| `upanishads` | Unknown author | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Guru_and_DiscipleI.jpg) |
| `upi` | NPCI | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:UPI_logo.svg) |
...
| `vaccination` | SELF Magazine | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Young_girl_about_to_receive_a_vaccine_in_her_upper_arm_(48545990252).jpg) |
| `valmiki` | Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Valmiki_Ramayana.jpg) |
| `van-gogh` | Vincent van Gogh | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Self-portrait_-_Vincent_van_Gogh.jpg) |
| `variolation` | George Kirtland | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Inoculation_day_16.png) |
| `vermeer` | Johannes Vermeer | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Cropped_version_of_Jan_Vermeer_van_Delft_002.jpg) |
| `vietnam-independence` | Warner Pathé News | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:French_indochina_1953_12_1.png) |
| `vijayanagara-empire` | Avantiputra7 | CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Vijayanagara_Empire_c.1485.png) |
| `virgil` | Armando Mancini | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Parco_della_Grotta_di_Posillipo5_(crop).jpg) |
| `virginia-woolf` | George Charles Beresford / Adam Cuerden | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:George_Charles_Beresford_-_Virginia_Woolf_in_1902_-_Restoration.jpg) |
| `vivekananda` | The original uploader was Dziewa at English Wikipedia. | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Swami_Vivekananda-1893-09-signed.jpg) |
| `von-neumann` | Unknown | Attribution | [Commons](https://commons.wikimedia.org/wiki/File:JohnvonNeumann-LosAlamos.jpg) |
| `wari` | QQuantum | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Map_of_Wari_and_Tiawaku.svg) |
| `warring-states` | China_Warring_States_Period.jpg: English Wikipedia, original upload 7 November 2004 by Yeu Ninje derivative work: Bility (talk) | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:China_Warring_States_Period.png) |
| `washington` | Gilbert Stuart | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Gilbert_Stuart_Williamstown_Portrait_of_George_Washington.jpg) |
| `wittgenstein` | Moritz Nähr | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Ludwig_Wittgenstein.jpg) |
| `woodblock-printing` | The colophon, at the inner end, reads: Reverently [caused to be] made for universal free distribution by Wang Jie on behalf of his two parents on the 13th of the 4th moon of the 9th year of Xiantong [i.e. 11th May, CE 868]. | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Jingangjing.jpg) |
| `world-wide-web` | Raimundo Pastor | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Alcal%C3%A1_de_Henares_(RPS_08-04-2017)_Calle_WWW,_indicador.png) |
| `wounded-knee` | Trager & Kuhn, Chadron, Nebr. | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Woundedkneesceneafterbattle.jpg) |
...
| `zero-decimal-system` | Chess x0l45.svg:: Betalph derivative work: Nik Naks talk - gallery - wikipedia i The source code of the previous SVG was invalid due to an error. | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Chess_x0t45.svg) |
| `zheng-he-voyages` | Photograph by Mike Peel (www.mikepeel.net). | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Zheng_He%27s_Treasure_Ship_3.jpg) |
| `zhou-dynasty` | Chinese_plain_5c._BC-fr.svg: Yug derivative work: Zunkir | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Zhou_capitales.svg) |
| `zimbabwe-independence` | CIA përpunuar nga Hipi Zhdripi | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:000_Zimbabveja_harta.PNG) |
| `zoroaster` | LBM1948 | CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Yazd,_Templo_del_Fuego_(2000)_02_(cropped).jpg) |
| `zulu-kingdom` | JMK | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Gees_van_eMakhosini-monument,_eMakhosini.jpg) |
